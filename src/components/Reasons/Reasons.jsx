        ...
        <div className="Reasons" id="reasons">
            ...
            <div className="right-r">
                ...
                <div className='details-r'>
                    <div><img src={tick} alt=""></img><span>OVER 140+ COACH</span></div>
                    <div><img src={tick} alt="" /><span>TRAIN SMARTER AND FASTER THAN BEFORE</span></div>
                    <div><img src={tick} alt="" /><span>FREE PROGRAM FOR NEW MEMEBER</span></div>
                    <div><img src={tick} alt="" /><span>RELIABLE PARTNER</span></div>
                </div>
                <span className='our-partner'>OUR PARTNERS</span>
                <div className="partners"><img src={nb} alt="" /><img src={adidas} alt="" /><img src={nike} alt="" /></div>
            </div>
        </div>
    )
}
